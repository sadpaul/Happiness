...
public class MarqueeView extends TextView {
    ...
    private void initView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mRollingInterval = typedArray.getInt(R.styleable.MarqueeView_scroll_interval, ROLLING_INTERVAL_DEFAULT);
        mScrollMode = typedArray.getInt(R.styleable.MarqueeView_scroll_mode, SCROLL_FOREVER);
        mFirstScrollDelay = typedArray.getInt(R.styleable.MarqueeView_scroll_first_delay, FIRST_SCROLL_DELAY_DEFAULT);
        typedArray.recycle();
        setSingleLine();
        setEllipsize(null);
    }
